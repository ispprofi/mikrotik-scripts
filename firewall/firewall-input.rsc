...
add action=jump chain=input comment="Jump to IN-LAN" rules" jump-target=IN-LAN
...
add action=jump chain=input comment="Jump to IN-Admin rules" jump-target=IN-Admin
